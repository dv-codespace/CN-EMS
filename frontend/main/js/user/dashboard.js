...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadFreshUserProfile() {
        ...
        try {
            ...
            if (regResponse.ok) {
                ...
                // Update page stats cards (if on dashboard.html)
    ...
    function initBannerCarousel() {
        ...
        const container = carousel.querySelector('.banner-container');
        const slides = carousel.querySelectorAll('.banner-slide');
        const dots = carousel.querySelectorAll('.banner-dots .dot');
        let currentIndex = 0;
        ...
        carousel.addEventListener('mouseleave', () => slideInterval = setInterval(nextSlide, 2000));
